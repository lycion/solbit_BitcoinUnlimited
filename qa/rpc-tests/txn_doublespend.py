...
class TxnMallTest(SolbitTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 1240 SBT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SBT coin each
        ...
        # Node0's total balance should be starting balance, plus 100SBT for 
