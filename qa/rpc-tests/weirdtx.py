...
def p2pkh_list(addr):
    return [OP_DUP, OP_HASH160, solbitAddress2bin(addr), OP_EQUALVERIFY, OP_CHECKSIG]
...
class MyTest (SolbitTestFramework):
    ...
    def setup_chain(self, solbitConfDict=None, wallets=None):
        ...
        initialize_chain_clean(self.options.tmpdir, 2, solbitConfDict, wallets)
    ...
    def run_test(self):
        ...
        # solbitd is not sophisticated enough to spend this ^
