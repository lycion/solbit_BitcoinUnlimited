...
class ExcessiveBlockTest (SolbitTestFramework):
    ...
    def run_test(self):
        ...
        SolbitTestFramework.run_test(self)
        self.testCli()
    ...
    def testExcessiveSigops(self):
        ...
        self.nodes[0].generate(100)  # create a lot of SBT for spending
...
def Test():
    ...
    t.main(["--tmpdir=/ramdisk/test", "--nocleanup", "--noshutdown"], solbitConf, None)
