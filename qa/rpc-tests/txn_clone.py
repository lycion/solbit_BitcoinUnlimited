...
class TxnMallTest(SolbitTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 SBT:
        ...
        # 40 SBT serialized is 00286bee00000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Node0's balance should be starting balance, plus 50SBT for another
        ...
        # Check node0's total balance; should be same as before the clone, + 100 SBT for 2 matured,
