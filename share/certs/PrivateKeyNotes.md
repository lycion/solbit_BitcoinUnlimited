...
unlocked to sign the Solbit-Qt.app bundle.
...
allowing somebody to distribute a Solbit-Qt.app or solbit-qt-setup.exe with a valid
...
that the solbit-qt.exe file inside the installer had not been tampered with.
