...
public:
    CMainParams()
    {
        ...
        */
        ...
        // List of Solbit Cash compatible seeders
        //vSeeds.push_back(CDNSSeedData("solbit.info", "sbtcash-seeder.solbit.info", true));
...
public:
    CUnlParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("solbit.info", "nolnet-seed.solbit.info", true));
...
public:
    CTestNetParams()
    {
        ...
        // Solbit ABC seeder
        vSeeds.push_back(CDNSSeedData("solbitabc.org", "testnet-seed.solbitabc.org", true));
        // solbitforks seeders
        vSeeds.push_back(CDNSSeedData("solbitforks.org", "testnet-seed-abc.solbitforks.org", true));
        // BU seeder
        vSeeds.push_back(CDNSSeedData("solbit.info", "testnet-seed.solbit.info", true));
        // Bitprim
