...
void CSolbitSecret::SetKey(const CKey &vchSecret)
{
...
bool CSolbitSecret::IsValid() const
{
...
bool CSolbitSecret::SetString(const char *pszSecret) { return CBase58Data::SetString(pszSecret) && IsValid(); }
bool CSolbitSecret::SetString(const std::string &strSecret) { return SetString(strSecret.c_str()); }
