...
const std::string strMessageMagic = "Solbit Signed Message:\n";
 ...
 *
 * See https://solbittalk.org/index.php?topic=8392.msg127623#msg127623
 *
    ...
    const CScript &scriptCode) const
{
    ...
    uint256 sighash;
    size_t nHashed = 0;
    // If SBT sighash is possible, check the bit, otherwise ignore the bit.  This is needed because
