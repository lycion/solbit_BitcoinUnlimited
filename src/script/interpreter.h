...
#ifndef SOLBIT_SCRIPT_INTERPRETER_H
#define SOLBIT_SCRIPT_INTERPRETER_H
...
// problems during signature hash calculations for any current SBT signature hash functions!
extern const uint256 SIGNATURE_HASH_ERROR;

// If you are signing you may call this function and the SolbitCash or Legacy method will be chosen based on nHashType
...
#endif // SOLBIT_SCRIPT_INTERPRETER_H
