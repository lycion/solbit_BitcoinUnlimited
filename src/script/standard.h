...
#ifndef SOLBIT_SCRIPT_STANDARD_H
#define SOLBIT_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a solbit address
 */
...
#endif // SOLBIT_SCRIPT_STANDARD_H
