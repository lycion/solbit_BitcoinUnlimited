...
#ifndef SOLBIT_TEST_SCRIPTNUM10_H
#define SOLBIT_TEST_SCRIPTNUM10_H
...
{
    /**
     * The ScriptNum implementation from Solbit Unlimited 0.10.0, for cross-comparison.
     */
public:
