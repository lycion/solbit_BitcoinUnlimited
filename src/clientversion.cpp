 ...
 * for both solbitd and solbit-core, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("SBCash");
...
/**
 //github.com/solbit/bips/blob/master/bip-0014.mediawiki)
