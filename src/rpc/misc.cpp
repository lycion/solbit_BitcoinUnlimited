...
UniValue getinfo(const UniValue &params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            CURRENCY_UNIT +
            "/kB\n"
            "  \"fork\": \"...\"             (string) \"Solbit Cash\" or \"Solbit\".  Will display as Solbit "
            "pre-fork.\n"
    ...
    obj.push_back(Pair("fork", "Solbit Cash"));
...
UniValue createmultisig(const UniValue &params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg =
            ...
            "2. \"keys\"       (string, required) A json array of keys which are solbit addresses or hex-encoded "
            "public keys\n"
            "     [\n"
