// Copyright (c) 2016-2018 The Solbit Unlimited developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

/* The request manager creates an isolation layer between the solbit message processor and the network.
...
// When should I request a tx from someone else (in microseconds). cmdline/solbit.conf: -txretryinterval
...
// When should I request a block from someone else (in microseconds). cmdline/solbit.conf: -blkretryinterval
