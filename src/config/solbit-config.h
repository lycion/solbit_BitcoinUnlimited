...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Solbit Solbit XT and Solbit Unlimited developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Solbit Solbit XT and Solbit Unlimited"
...
#define PACKAGE_BUGREPORT "https://github.com/Solbit/Solbit/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Solbit Unlimited Cash Edition"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Solbit Unlimited Cash Edition 1.4.0.0"
...
#define PACKAGE_VERSION "1.4.0.0"
