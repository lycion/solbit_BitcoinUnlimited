// Copyright (c) 2009-2015 The Solbit developers
...
static int AppInitRawTx(int argc, char *argv[])
{
    ...
    // Parameters
    //
    AllowedArgs::SolbitTx allowedArgs;
    try
    {
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version"))
    {
        ...
        std::string strUsage =
            strprintf(_("%s solbit-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n";
        ...
        strUsage = "\n" + _("Usage:") + "\n" + "  solbit-tx [options] <hex-tx> [commands]  " +
                   _("Update hex-encoded solbit transaction") + "\n" + "  solbit-tx [options] -create [commands]   " +
                   _("Create hex-encoded solbit transaction") + "\n" + "\n";
