...
#ifndef SOLBIT_ALLOWED_ARGS_H
#define SOLBIT_ALLOWED_ARGS_H
...
class SolbitCli : public AllowedArgs
{
public:
    SolbitCli();
};

class Solbitd : public AllowedArgs
{
public:
    Solbitd(CTweakMap *pTweaks = nullptr);
};

class SolbitQt : public AllowedArgs
{
public:
    SolbitQt(CTweakMap *pTweaks = nullptr);
};

class SolbitTx : public AllowedArgs
{
public:
    SolbitTx();
};
