// Copyright (c) 2011-2017 The Solbit Unlimited developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SOLBIT_QT_UNLIMITEDDIALOG_H
#define SOLBIT_QT_UNLIMITEDDIALOG_H
...
// Minimum time in ms to show notifications (used in SolbitGUI not the Unlimited dialog)
