...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSolbitURI(*cfg, info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " +
                SolbitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
void ReceiveRequestDialog::on_btnCopyURI_clicked() { GUIUtil::setClipboard(GUIUtil::formatSolbitURI(*cfg, info)); }
