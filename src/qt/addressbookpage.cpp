    ...
    : QDialog(parent), ui(new Ui::AddressBookPage), model(0), mode(_mode), tab(_tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your Solbit addresses for sending payments. Always check the "
                                         "amount and the receiving address before sending coins."));
        ui->deleteAddress->setVisible(true);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Solbit addresses for receiving payments. It is recommended "
