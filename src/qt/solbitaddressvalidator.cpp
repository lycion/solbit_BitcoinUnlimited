...
SolbitAddressEntryValidator::SolbitAddressEntryValidator(const std::string &_cashaddrprefix, QObject *parent)
    : QValidator(parent), cashaddrprefix(_cashaddrprefix)
{
}

QValidator::State SolbitAddressEntryValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
...
SolbitAddressCheckValidator::SolbitAddressCheckValidator(QObject *parent) : QValidator(parent) {}
QValidator::State SolbitAddressCheckValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
