...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    if (SolbitUnits::parse(model->getOptionsModel()->getDisplayUnit(), amount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(SolbitUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0,
