...
#ifndef SOLBIT_QT_TRANSACTIONTABLEMODEL_H
#define SOLBIT_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx,
        ...
        SolbitUnits::SeparatorStyle separators = SolbitUnits::separatorStandard) const;
...
#endif // SOLBIT_QT_TRANSACTIONTABLEMODEL_H
