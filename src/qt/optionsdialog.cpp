// Copyright (c) 2011-2015 The Solbit Core, Unlimited, and XT developers
...
/* Window elements init */
    ...
    ui->solbitAtStartup->setToolTip(ui->solbitAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->solbitAtStartup->setText(ui->solbitAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new SolbitUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->solbitAtStartup, OptionsModel::StartAtStartup);
