...
#ifndef SOLBIT_QT_RECEIVECOINSDIALOG_H
#define SOLBIT_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of solbits */
...
#endif // SOLBIT_QT_RECEIVECOINSDIALOG_H
