      ...
      fProcessingQueuedTransactions(false), platformStyle(_platformStyle)
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Address or Label")
            << SolbitUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
    priv->refreshWallet();
...
{
    columns[Amount] = SolbitUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx,
    ...
    SolbitUnits::SeparatorStyle separators) const
{
    QString str = SolbitUnits::format(
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, SolbitUnits::separatorAlways);
        }
        break;
    case Qt::EditRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, SolbitUnits::separatorNever);
    case StatusRole:
