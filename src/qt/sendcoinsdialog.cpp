...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    processSendCoinsReturn(prepareStatus, SolbitUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(),
    ...
    Q_FOREACH (const SendCoinsRecipient &rcp, currentTransaction.getRecipients())
    {
        ...
        else
        {
            ...
            QString amount =
                "<b>" + SolbitUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), rcp.amount);
            amount.append("</b>");
    ...
    if (txFee > 0)
    {
        ...
        questionString.append(SolbitUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), txFee));
    ...
    Q_FOREACH (SolbitUnits::Unit u, SolbitUnits::availableUnits())
    {
        if (u != model->getOptionsModel()->getDisplayUnit())
            alternativeUnits.append(SolbitUnits::formatHtmlWithUnit(u, totalAmount));
    }
    questionString.append(
        tr("Total Amount %1")
            .arg(SolbitUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), totalAmount)));
    ...
    const CAmount &watchImmatureBalance)
{
    ...
    if (model && model->getOptionsModel())
    {
        ui->labelBalance->setText(SolbitUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), balance));
    }
}
    ...
    case WalletModel::AbsurdFee:
        msgParams.first =
            tr("A fee higher than %1 is considered an absurdly high fee.")
                .arg(SolbitUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), maxTxFee.Value()));
        break;
...
void SendCoinsDialog::updateFeeMinimizedLabel()
{
    ...
    else
    {
        ui->labelFeeMinimized->setText(
            SolbitUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), ui->customFee->value()) +
    ...
    if (model && model->getOptionsModel())
        ui->checkBoxMinimumFee->setText(
            tr("Pay only the required fee of %1")
                .arg(SolbitUnits::formatWithUnit(
...
void SendCoinsDialog::updateSmartFeeLabel()
{
    ...
    {
        ui->labelSmartFee->setText(SolbitUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(),
