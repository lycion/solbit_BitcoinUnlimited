...
#ifndef SOLBIT_QT_SOLBITUNITS_H
#define SOLBIT_QT_SOLBITUNITS_H
...
*/
class SolbitUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SolbitUnits(QObject *parent);

    /** Solbit units.
      @note Source: https://en.solbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SBT,
...
typedef SolbitUnits::Unit SolbitUnit;

#endif // SOLBIT_QT_SOLBITUNITS_H
