...
UniValue importprivatekeys(const UniValue &params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1)
        throw runtime_error(
            "importprivatekeys [rescan | no-rescan] \"solbitprivatekey\"...\n"
            ...
            "2. \"solbitprivatekey\"   (string, at least 1 required) The private keys (see dumpprivkey)\n"
...
UniValue dumpprivkey(const UniValue &params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error("dumpprivkey \"solbitaddress\"\n"
    ...
    return CSolbitSecret(vchSecret).ToString();
}
...
UniValue dumpwallet(const UniValue &params, bool fHelp)
{
    ...
    for (std::vector<std::pair<int64_t, CKeyID> >::const_iterator it = vKeyBirth.begin(); it != vKeyBirth.end(); it++)
    {
        ...
        {
            file << strprintf("%s %s ", CSolbitSecret(key).ToString(), strTime);
