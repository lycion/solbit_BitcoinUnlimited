...
#ifndef SOLBIT_UNLIMITED_H
#define SOLBIT_UNLIMITED_H
...
extern uint256 solbitCashForkBlockHash;
...
extern void GenerateSolbits(bool fGenerate, int nThreads, const CChainParams &chainparams);
