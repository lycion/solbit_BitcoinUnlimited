...
This document provides guidelines for internationalization of the Solbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `solbit_en.ts` remains unchanged.
