...
1. Run solbit behind a Tor proxy
---------------------------------
...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./solbit -proxy=127.0.0.1:9050


2. Run a solbit hidden server
------------------------------
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./solbitd -proxy=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./solbitd ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./solbit -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
...
Solbit Unlimited has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Solbit Unlimited automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Solbit Unlimited is listening, and
...
solbitd is going to be executed has write permission on tor system directories
...
Add these lines to your `solbit.conf` file
...
Then issue this command to get the url of your onion hidden service
	...
	solbit-cli getnetworkinfo | grep -w addr
...
Remove your peer file and tor private key from solbit data directory
...
your solbit node, in such a way your attacker won't be able to harm you
