...
Below are some notes on how to build Solbit Unlimited for Windows.
...
way. This will install to `c:\workspace\solbit`, for example:

    make install DESTDIR=/mnt/c/workspace/solbit
