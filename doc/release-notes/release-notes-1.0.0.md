Release Notes for Solbit Unlimited v1.0.0
==========================================

Solbit Unlimited version 1.0.0 is now available from:
...
The third official BU client release reflects our opinion that Solbit full-node
...
stalled network effect growth, based on Solbit Unlimited's Emergent Consensus
model to let the ecosystem decide the best values of parameters like the maximum
block size.

Solbit Unlimited open-source version 1.0.0 contains a large number of changes,
...
imported from the open source work of the Solbit Core developers who deserve
...
In co-operation with Solbit XT a potential attack on SG has been identified. A
...
Solbit Unlimited recommends miners and commercial node users set their
...
When a Solbit node validates transactions, it verifies signatures. These
...
Further information:
- [Github Repository PR#164](https://github.com/Solbit/Solbit/pull/164)
...
Satoshi Nakamoto implemented a 32MB message limit in Solbit. To prevent any
...
Solbit Unlimited differentiates useful and less useful data between nodes.
...
spy nodes, From version 1.0.0, Solbit Unlimited Nodes track if peers supply
useful data.
...
Further information:
- [GitHub #PR 62](https://github.com/Solbit/Solbit/pull/62)

Request Manager extensions
--------------------------

Solbit Unlimited uses a Request Manager that tracks source nodes for blocks and
...
Further information:
- [GitHub PR #79](https://github.com/Solbit/Solbit/pull/79)
- [GitHub PR #229](https://github.com/Solbit/Solbit/pull/229)

Xthin block propagation optimizations
-------------------------------------

Based on many months of live traffic observation, Solbit Unlimited implemented
...
Further information:
- [GitHub PR #131](https://github.com/Solbit/Solbit/pull/131)
- [GitHub PR #173](https://github.com/Solbit/Solbit/pull/173)
- [GitHub PR #174](https://github.com/Solbit/Solbit/pull/174)
- [GitHub PR #176](https://github.com/Solbit/Solbit/pull/176)
- [GitHub PR #191](https://github.com/Solbit/Solbit/pull/191)
...
Further information:
- [GitHub PR #42](https://github.com/Solbit/Solbit/pull/42)
- [GitHub PR #100](https://github.com/Solbit/Solbit/pull/100)
...
lkcoinse.conf, Solbit Unlimited introduces a new format using the dot notation.
...
luke-jr, sipa, 21 and others. Solbit Unlimited aims to create its own DNS seed
capable of special requirements such as supporting the service bit of XTHIN. By
adopting and adjusting Sipa's code for a DNS seed Solbit Unlimited fixed a
minor bug.

The DNS Seed of Solbit Unlimited is currently activated on the NOL (No Limit)
Net, the testnet for Solbit Unlimited's Emergent Consensus. It is expected to
...
reorganizing global variables in a single file Solbit Unlimited fixed the
destruction order and eliminates this bug. This is especially helpful for
running lkcoinsed test suite.

Further information:
- [GitHub PR #67](https://github.com/Solbit/Solbit/pull/67)

Lock order checking in debug mode
---------------------------------

Solbit's debug mode checks that locks are taken in a consistent order to
...
offered. This was backported from the Solbit Core project and adjusted for the
Solbit Unlimited environment.


Imported Commits
================

Changes from the open source Solbit Core Project
-------------------------------------------------
...
Solbit Unlimited has therefore cherry-picked a number of Solbit Core 0.13.x
updates and upgrades which align with BU's onchain-scaling and wider goals to
advance Solbit. We would like to thank developers Cory Fields, Jonas
...
- `37214f7` Rebrand Solbit Core as Solbit
...
- `e9bba70` [qa] print out seed in SolbitTestFramework instead of requiring tests to do it
