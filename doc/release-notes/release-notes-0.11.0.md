Solbit Core version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer SBT/kB fee to be
...
Block pruning allows Solbit Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Solbit Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only SolbitAmountField
...
- #6116 `30dc3c1` [OSX] rename Solbit-Qt.app to Solbit-Core.app
