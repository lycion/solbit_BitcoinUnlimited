Solbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/lkcoinse/files/Solbit/lkcoinse-0.5.4/
...
Fix Solbit-Qt notifications under Growl 1.3.
Increase required age of Solbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSolbit properly when installing Solbit-Qt over it. (Windows)
