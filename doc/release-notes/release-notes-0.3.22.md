Download URL: https://sourceforge.net/projects/lkcoinse/files/Solbit/lkcoinse-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SBT fee schedule (users still pay 0.01 SBT per kb, until next version)
