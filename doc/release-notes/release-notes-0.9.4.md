Solbit Core version 0.9.4 is now available from:
...
this update is incompatible with the Solbit system and could lead to consensus
forks.

Solbit Core released binaries from https://lkcoinse.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lkcoinse/+archive/ubuntu/lkcoinse
- A third-party or self-compiled Solbit Core

upgrade to Solbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
